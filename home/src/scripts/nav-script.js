...
var nabar = document.querySelector('.nav-container')
...
window.onscroll = () => {
    ...
    if (window.scrollY > 20) {
        ...
        // Y sino, o osea, si estas menos de 20 pixeles, quitale la clase nav-active
        navigator.classList.remove('nav-active');
    }
};